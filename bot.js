...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'باك') {  //WESO#0001
      msg.reply('** :wink: ولكم نورت   :sparkling_heart:**');  //WESO#0001
    }
  });
...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'فزاع') {  //WESO#0001
      msg.reply('الطاوات ');  //WESO#0001
    }
  });
...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'اسلام') {  //WESO#0001
      msg.reply('**ملك الكونكر كلين**');  //WESO#0001
    }
  });


client.on('message', msg => {  //WESO#0001
    if (msg.content === 'روك') {  //WESO#0001
      msg.reply('**اهم شئ الاخلاق**');  //WESO#0001
    }
  });

client.on('message', msg => {  //WESO#0001
    if (msg.content === 'فينوس') {  //WESO#0001
      msg.reply('**المحززززم**');  //WESO#0001
    }
  });

client.on('message', msg => {  //WESO#0001
    if (msg.content === 'سجاد') {  //WESO#0001
      msg.reply('**المحترم**');  //WESO#0001
    }
  });
...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'سنوكس') {  //WESO#0001
      msg.reply('**ملك الباندات**');  //WESO#0001
    }
  });

client.on('message', msg => {  //WESO#0001
    if (msg.content === 'شوقي') {  //WESO#0001
      msg.reply('**الظابط حقنا**');  //WESO#0001
    }
  });
...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'دراكولا') {  //WESO#0001
      msg.reply('**الصاحب الجدع**');  //WESO#0001
    }
  });
...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'كريزي') {  //WESO#0001
      msg.reply('**راعي الوان شوت**');  //WESO#0001
    }
  });
...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'ابراهيم') {  //WESO#0001
      msg.reply('**ابو قلب طيب**');  //WESO#0001
    }
  });
...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'عمر') {  //WESO#0001
      msg.reply('**اه اه**');  //WESO#0001
    }
  });

client.on('message', msg => {  //WESO#0001
    if (msg.content === '.') {  //WESO#0001
      msg.reply('**احلي من ينقط**');  //WESO#0001
    }
  });

client.on('message', msg => {  //WESO#0001
    if (msg.content === 'كنتاكي') {  //WESO#0001
      msg.reply('**عربيه مين اللي هناك دي؟؟**');  //WESO#0001
    }
  });
...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'خالد') {  //WESO#0001
      msg.reply('**الخلوق**');  //WESO#0001
    }
  });

client.on('message', msg => {  //WESO#0001
    if (msg.content === 'الشغب') {  //WESO#0001
      msg.reply('**نمبر وان**');  //WESO#0001
    }
  });

client.on('message', msg => {  //WESO#0001
    if (msg.content === 'تهاني') {  //WESO#0001
      msg.reply('**القلب الابيض**');  //WESO#0001
    }
  });


client.on('message', msg => {  //WESO#0001
    if (msg.content === 'بدر') {  //WESO#0001
      msg.reply('**هاااا شو بدك**');  //WESO#0001
    }
  });

client.on('message', msg => {  //WESO#0001
    if (msg.content === 'مهدي') {  //WESO#0001
      msg.reply('**ايش تبي من انوب هاك**');  //WESO#0001
    }
  });
 ...
 client.on('message', msg => {  
   ...
   client.on('message', msg => {  
    if (msg.content === 'كل خرا') { 
      msg.reply('**عيوني .. حط نفسك في طبق واكلك**'); 
    }
  });
   ...
   client.on('message', msg => { 
    ...
    if (msg.content === 'صباح الخير') {  
      msg.reply('**صباح المانقو ي مانقو..**');  
    }
  });
    ...
    if (msg.content === 'مساء الخير') {  
     ...
     client.on('message', msg => {  
    if (msg.content === 'مساء الخير @everyone') {  
      msg.reply('**مساء الترتر ..**');  
    }
  });
     ...
     client.on('message', msg => {  
    if (msg.content === 'صباح الخير @everyone') {  
      msg.reply('**صباح المانقو ي مانقو..**');  
    }
  });
     ...
     client.on('message', msg => {  
    if (msg.content === 'مساء الخير @here') {  
      msg.reply('**مساء الترتر ..**');  
    }
  });
     ...
     client.on('message', msg => {  
    if (msg.content === 'صباح الخير @here') {  
      msg.reply('**صباح المانقو ي مانقو..**');  
    }
  });
    ...
    client.on('message', msg => {  
    if (msg.content === 'فلاح') {  
      msg.reply('**التايقر المتوحش..**');  
    }
  });

    client.on('message', msg => {  
    if (msg.content === 'سهام') {  
      msg.reply('**حبيبة امنية**');  
    }
  });

    client.on('message', msg => {  
    if (msg.content === 'امنيه') {  
      msg.reply('**حبيبة سهام**');  
    }
  });

    client.on('message', msg => {  
    if (msg.content === 'طعميه') {  
      msg.reply('**ملك التفجير**');  
    }
  });
...
9) ممنوع التكلم عن مشاكل وخلافات ببجي والكلام يكون في حدود الوناسه
__PUBG MOBILE 
